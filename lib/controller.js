...
Controller.prototype.assertVersion = function (minVersion, errMsg) {
  if (this._serverVersion < minVersion) {
    this.emitError(`${errMsg}: TWS ${this._serverVersion} must be at least ${minVersion}.`);
    return true;
  } else {
    return false;
  }
